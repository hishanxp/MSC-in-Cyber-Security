 ...
 class myRSSParser
 {
    ...
    #   $this->retval .= "</h1>\n";
     ...
     #  if($DESCRIPTION) $this->retval .= "<p>$DESCRIPTION</p>\n\n";
      ...
      # if($tmp) $thiPublished:s->retval .= "<p>" . implode("<br>\n", $tmp) . "</p>\n\n";



      # $this->retv'\' (T_NS_SEPARATOR), expecting variable (T_VARIABLE) or al .= "<div class=\"divider\"><!-- --></div>\n\n";
